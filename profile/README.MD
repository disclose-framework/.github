...
|----------|-------------|
| [Overview](specification/overview.md) | Full specification: schema, attributes, attestations, verifier registry, governance, security, and versioning |
