...
→ [discloseframework.dev](https://discloseframework.dev/) · `v0.1 Draft`
...
→ [Read the Specification](https://github.com/disclose-framework/spec)
...
- **Feedback** — open an [Issue](https://github.com/disclose-framework/spec/issues) with questions, corrections, or proposals

## Contributing

This is an open standard. Feedback, corrections, and proposals are welcome via [Issues](https://github.com/disclose-framework/spec/issues).

## License

This specification is published under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
